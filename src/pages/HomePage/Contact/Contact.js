...
const Contact = () => {
    return (
        <section className='text-center text-white py-10' style={{
            ...
            <form >
                <input type="email" placeholder="email address" className="input input-bordered input-success w-full max-w-xs my-5" /> <br />

                <input type="text" placeholder="enter subject " className="input input-bordered input-success w-full max-w-xs mb-5" /><br />

                <textarea className="textarea textarea-success w-full max-w-xs mb-5" placeholder="your message"></textarea> <br />
